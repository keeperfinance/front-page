...
module.exports = {
  siteMetadata: {
    title: `Keeper Finance`,
    description: `An Advanced DeFi Keeper Network`,
    author: `@keeperfinance`,
    menulinks: menu,
    siteUrl: `https://keeper.finance`,
    repository: `https://github.com/keeperfinance/`,
  ...
  plugins: [
      ...
      options: {
        ...
        gatsbyRemarkPlugins: [
          ...
          // `gatsby-remark-check-links`,
          {
            ...
            options: {
              title: 'Keeper Finance', // website title
              separator: '|', // default
              author: '@keeperfinance',
        ...
        feeds: [
          {
            ...
            `,
            output: '/rss.xml',
            title: 'Keeper Finance Blog RSS Feed'
          }
        ]
      }
    },
    'gatsby-plugin-eslint',
    {
      ...
      options: {
        ...
        indexName: 'keeperfinance_v2_docs',
        appId: 'VZ0CVS8XCW',
